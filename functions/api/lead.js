...
export async function onRequestPost(context) {
  try {
    ...
    var lead = {
      ...
      trafficSource: cleanOptional(payload.traffic_source),
      trafficMedium: cleanOptional(payload.traffic_medium),
      trafficCampaign: cleanOptional(payload.traffic_campaign),
      firstPage: cleanOptional(payload.first_page),
      firstReferrer: cleanOptional(payload.first_referrer),
      firstUtmSource: cleanOptional(payload.first_utm_source),
      firstUtmMedium: cleanOptional(payload.first_utm_medium),
      firstUtmCampaign: cleanOptional(payload.first_utm_campaign),
      firstUtmTerm: cleanOptional(payload.first_utm_term),
      firstUtmContent: cleanOptional(payload.first_utm_content),
      firstGclid: cleanOptional(payload.first_gclid),
      firstFbclid: cleanOptional(payload.first_fbclid),
      firstMsclkid: cleanOptional(payload.first_msclkid),
      firstSeenAt: cleanOptional(payload.first_seen_at),
